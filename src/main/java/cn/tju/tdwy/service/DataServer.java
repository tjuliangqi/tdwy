...
public class DataServer {
    ...
    public static Map<String,Object> city() throws IOException {
        ...
        for (SearchHit searchHit : searchHits){
            ...
            in.put(hitMap.get("carNum").toString(),hitMap.get("countIn"));
            out.put(hitMap.get("carNum").toString(),hitMap.get("countOut"));
        }
        result.put("in",in);
        result.put("out",out);
        return result;
    ...
    public static Map<String,Object> time() throws IOException, ParseException {
        Map<String,Object> result = new HashMap<>();
